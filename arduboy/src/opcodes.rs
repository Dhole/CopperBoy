...
impl OpType {
    pub fn new_from_op(op: Op) -> Self {
        match op {
            ...
            Op::Cpse { .. } => OpType::Cpse,
            Op::Dec { .. } => OpType::Dec,
            Op::Eicall { .. } => OpType::Eicall,
            Op::Eijmp { .. } => OpType::Eijmp,
            Op::Elpmr0 { .. } => OpType::Elpmr0,
            Op::Elpm { .. } => OpType::Elpm,
            Op::Eor { .. } => OpType::Eor,
            Op::Fmul { .. } => OpType::Fmul,
            Op::Fmuls { .. } => OpType::Fmuls,
            Op::Fmulsu { .. } => OpType::Fmulsu,
            Op::Icall { .. } => OpType::Icall,
            Op::Ijmp { .. } => OpType::Ijmp,
            Op::In { .. } => OpType::In,
            Op::Inc { .. } => OpType::Inc,
            Op::Jmp { .. } => OpType::Jmp,
